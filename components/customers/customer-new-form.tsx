    ...
    <div className="space-y-6 max-w-4x2">
      ...
      {success && (
        <Alert className="bg-accent/10 border-accent/30 text-accent">
          <AlertCircle className="h-4 w-4" />
          <AlertDescription>Cliente creado correctamente. Redirigiendo...</AlertDescription>
        </Alert>
      )}
        ...
        <Card className="bg-card border-border">
          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">Opcional: asigna un router para segmentación de red</p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-card border-border">
          <CardHeader className="flex flex-row items-center justify-between">
            <div>
              ...
              <CardDescription>Direcciones asociadas al cliente (opcional)</CardDescription>
            </div>
          ...
          <CardContent className="space-y-4">
            {addresses.length === 0 ? (
              <div className="text-center py-8 text-muted-foreground border border-dashed border-border rounded-lg">
                ...
                <p className="text-sm">Puedes agregarlas ahora o después</p>
              </div>
            ) : (
